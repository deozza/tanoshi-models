...
import { FONT_SIZES, TEXT_ALIGNMENT, FONT_WEIGHTS, type HOVER_LINK_THEMES, type LINK_THEMES, type TEXT_DECORATIONS, type TEXT_TRANSFORMS } from "$lib/enums/TextEnums.js";
