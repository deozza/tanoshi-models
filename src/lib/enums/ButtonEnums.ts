...
export enum BUTTON_HOVER_TEXT_THEMES {
	Primary = 'button-hover-text-primary',
	Secondary = 'button-hover-text-secondary',
	Success = 'button-hover-text-success',
	Warning = 'button-hover-text-warning',
	Danger = 'button-hover-text-danger',
	Info = 'button-hover-text-info',
	Black = 'button-hover-text-black',
	White = 'button-hover-text-white'
}
