export enum PILL_TEXT_THEMES {
	Primary = 'pill-text-primary',
	Secondary = 'pill-text-secondary',
	Success = 'pill-text-success',
	Warning = 'pill-text-warning',
	Danger = 'pill-text-danger',
	Info = 'pill-text-info',
	Black = 'pill-text-black',
	White = 'pill-text-white'
}
