...
describe('TanoshiLabelModel', () => {
	...
	test('default classes', () => {
		...
		expect(tanoshiLabelModel.getClasses()).toEqual(
			'tanoshi-label text-theme-primary font-size-md text-align-left font-weight-regular'
		);
	});
	...
	test('set text theme', () => {
		...
		tanoshiLabelModel.setTextTheme(THEMES.Primary);
	...
	test('set custom text theme', () => {
		...
		tanoshiLabelModel.setTextTheme(LABEL_TEXT_THEMES.Primary);

		expect(tanoshiLabelModel.getClasses()).toEqual(
			'tanoshi-label text-theme-label-text-primary font-size-md text-align-left font-weight-regular'
		);
	});
	...
	test('set font size', () => {
		...
		tanoshiLabelModel.setFontSize(FONT_SIZES['6Xl']);

		expect(tanoshiLabelModel.getClasses()).toEqual(
			'tanoshi-label text-theme-primary font-size-6xl text-align-left font-weight-regular'
		);
	});
	...
	test('set text alignment', () => {
		...
		tanoshiLabelModel.setTextAlignment(TEXT_ALIGNMENT.Center);

		expect(tanoshiLabelModel.getClasses()).toEqual(
			'tanoshi-label text-theme-primary font-size-md text-align-center font-weight-regular'
		);
	});
	...
	test('set font weight', () => {
		...
		tanoshiLabelModel.setFontWeight(FONT_WEIGHTS.Bold);

		expect(tanoshiLabelModel.getClasses()).toEqual(
			'tanoshi-label text-theme-primary font-size-md text-align-left font-weight-bold'
		);
	});
	...
	test('set text transform', () => {
		...
		tanoshiLabelModel.setTextTransform(TEXT_TRANSFORMS.Capitalize);

		expect(tanoshiLabelModel.getClasses()).toEqual(
			'tanoshi-label text-theme-primary font-size-md text-align-left font-weight-regular text-transform-capitalize'
		);
	});
	...
	test('set text decoration', () => {
		...
		tanoshiLabelModel.setTextDecoration(TEXT_DECORATIONS.Underline);

		expect(tanoshiLabelModel.getClasses()).toEqual(
			'tanoshi-label text-theme-primary font-size-md text-align-left font-weight-regular text-decoration-underline'
		);
	});
	...
	test('set is visible', () => {
		...
		tanoshiLabelModel.setIsVisible(false);
